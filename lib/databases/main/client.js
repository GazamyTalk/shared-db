...
class UserClient {
    ...
    update(beforeUserInfo, afterUserInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.UserInfoModel.updateMany(beforeUserInfo, afterUserInfo, { multi: true });
    ...
    delete(userInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.UserInfoModel.deleteMany(userInfo, { multi: true });
